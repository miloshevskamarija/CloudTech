...
def main():
    ...
    leading_pt_all = concat_from_infos("leading_pt_GeV")
    eta_all = concat_from_infos("eta")
    m12_all = concat_from_infos("m12_GeV")
    m34_all = concat_from_infos("m34_GeV")
    dR_all = concat_from_infos("dR_lep01")
    ...
    # Overlay Z and Higgs reference masses
    mZ = 91.1876
    mH = 125.0
